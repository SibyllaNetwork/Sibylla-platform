...
const MENU_MAP: Record<string, string> = {
  ...
  // Operation — Food & Beverage (Outlet Manager)
  'fb-dashboard':               'fa-gauge-high',
  'fb-operativo':               'fa-bell-concierge',
  'gest-comanda':               'fa-receipt',
  'fb-kds':                     'fa-fire-burner',
  'fb-cassa':                   'fa-cash-register',
  'fb-economato':               'fa-warehouse',
  'fb-ingredienti':             'fa-carrot',
  'fb-food-cost':               'fa-scale-balanced',
  'sala-ristorante':            'fa-utensils',
  'libro-prenotazioni':         'fa-book',
  'ospiti-giorno':              'fa-users',
  'fb-struttura':               'fa-building',
  'fb-outlet':                  'fa-shop',
  'fb-sale-tavoli':             'fa-chair',
  'fb-turni':                   'fa-clock',
  'fb-menu':                    'fa-book-open',
  'fb-tipi-menu':               'fa-folder-open',
  'fb-categorie':               'fa-tags',
  'fb-voci-menu':               'fa-plate-utensils',
  'fb-menu-giorno':             'fa-bookmark',
  'fb-web-menu':                'fa-globe',
  'fb-generali':                'fa-sliders',
  'fb-allergeni':               'fa-triangle-exclamation',
  'fb-categoria-ospite':        'fa-user-tag',
  'fb-stampanti':               'fa-print',
  'fb-service-monitor':         'fa-display',
  'fb-config-email':            'fa-envelope',
  'fb-mobile-wallet':           'fa-mobile-screen',
  'fb-amministrazione':         'fa-user-shield',
  'fb-utenti':                  'fa-users-gear',
  'fb-wallet-clienti':          'fa-wallet',
  'fb-ruoli':                   'fa-shield-halved',
