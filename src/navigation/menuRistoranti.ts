// ─── MENU RISTORANTI ──────────────────────────────────────────────────────────
// Sidenav dedicata ai profili con categoria/modulo "Ristoranti" (es. Marco Bruno
// — Sky Lounge Bar, contratto "Ristorazione Sud"). Struttura ricavata da
// ristoranti.xlsx (alla radice del progetto). Dove la voce coincide con il MENU
// principale si riusa lo stesso id (eredita icona MenuIco + pagina/handler in
// PageContent); le voci specifiche Ristoranti (sezione "Menu", "Turni" F&B) hanno
// id nuovi con page = id → fallback GenericPage, con icona aggiunta in MenuIco.

const MENU_RISTORANTI:any[]=[
  ...
  {id:"impresa",label:"Impresa",icon:"wheel",children:[
    ...
    {id:"operation",label:"Operation",color:"#5A8A3C",children:[
      ...
      {id:"menu-rist",label:"Menu",children:[
        ...
        {id:"categorie-menu",label:"Categorie",page:"categorie-menu"},
        {id:"voci-menu",label:"Voci menu",page:"voci-menu"},
        {id:"menu-giorno",label:"Menu del giorno",page:"menu-giorno"},
        {id:"web-menu",label:"Web menu",page:"web-menu"},
      ]},
      {id:"sale-tavoli",label:"Sale e tavoli",page:"sale-tavoli"},
      {id:"turni-fb",label:"Turni",page:"turni-fb"},
...
export default MENU_RISTORANTI;
